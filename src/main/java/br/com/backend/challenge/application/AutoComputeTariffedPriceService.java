...
@Service
public class AutoComputeTariffedPriceService implements ComputeTariffedPriceUseCase {

    private static final Logger LOGGER = LoggerFactory.getLogger(AutoComputeTariffedPriceService.class);
