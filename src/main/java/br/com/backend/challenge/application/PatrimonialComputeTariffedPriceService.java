...
@Service
public class PatrimonialComputeTariffedPriceService implements ComputeTariffedPriceUseCase {

    private static final Logger LOGGER = LoggerFactory.getLogger(PatrimonialComputeTariffedPriceService.class);
